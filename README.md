...
For now I have to abide by the native rules of NGEN, once I fully integrate I expect the surface generation to have much better performance. Right now, it runs on vsync at 60+hz on my desktop with an RTX card. 
